...
- Create Angular project with ng: `ng new the16oracles.www.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`the16oracles.www.client.esproj`).
